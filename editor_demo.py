...
from typing_bot.struct_editor import StructuredParser
...
<COMMANDS: VSCODE>
    ...
    print("1. Sample .sxt file content:")
    print("-" * 50)
    ...
    try:
            ...
            def _simulate_typing_result(self, commands):
                ...
                while i < len(commands):
                    ...
                    if char == "\a":
                        ...
                        line = text_buffer[cursor_line]
                        text_buffer[cursor_line] = (
                            line[:cursor_col] + char + line[cursor_col:]
                        )
                        cursor_col += 1
        ...
        final_result = mock_editor.simulate_execution(
            sample_content, 100
        )  # Show full execution
        ...
        print("• Syntax highlighting for .sxt format:")
        ...
        print("python struct_editor.py examples/example.sxt")
        print()
...
def show_editor_layout():
    ...
    print("=" * 80)
    print(
        "┌─────────────────────── Source (.sxt) ─────────────┬── Final Text Preview ───┐"
    )
    print(
        "│  1 <CODE: PYTHON>                                     │Final Text Preview        │"
    )
    print(
        "│  2     # Python code with shortcuts                  │                          │"
    )
    print(
        "│  3     import numpy as np                            │  1: # Python code with s │"
    )
    print(
        "│ >4                                                   │  2: import numpy as np   │"
    )
    print(
        "│  5     def calculate_mean(data):                     │  3:                      │"
    )
    print(
        "│  6         return np.mean(data)                      │  4: def calculate_mean(d │"
    )
    print(
        "│  7                                                   │  5:     return np.mean(d │"
    )
    print(
        '│  8     if __name__ == "__main__":                    │  6:                      │'
    )
    print(
        '│  9         data = [1, 2, 3, 4, 5]                   │  7: if __name__ == "__ma │'
    )
    print(
        "│ 10         result = calculate_mean(data)             │  8:     data = [1, 2, 3, │"
    )
    print(
        '│ 11         print(f"DEBUG: {}")                       │  9:     result = calcula │'
    )
    print(
        '│ 12 </CODE>                                           │ 10:     print(f"DEBUG: {│'
    )
    print(
        "│ 13                                                   │ 11:                      │"
    )
    print(
        '│ 14 <COMMANDS>                                        │ 12: print(f"Mean: {resul│'
    )
    print(
        "│ 15     ARROW_UP 2                                    │ 13:                      │"
    )
    ...
    print(
        "│examples/example.sxt* - L4:C1    Ctrl+S:Save │ ↑↓:Navigate │ Ctrl+Q:Quit              │"
    )
    print(
        "└───────────────────────────────────────────────────────────────────────────────────┘"
    )
    ...
    print("• Left pane shows editable .sxt source with syntax highlighting")
    print(
        "• Right pane shows final text that would result from execution up to current line"
    )
...
if __name__ == "__main__":
    ...
    print("python struct_editor.py [filename.sxt]")
    print("=" * 80)
